...
<style>
  ...
  * { margin: 0; box-sizing: border-box; }
  ...
  h1 { font-family: "EB Garamond", Georgia, serif; font-size: 68px; line-height: 1.08;
       font-weight: 600; letter-spacing: 0; max-width: 15ch; }
  ...
  .l { font-size: 17px; color: #56616B; margin-top: 4px; }
  .rules { display: flex; gap: 10px; margin-bottom: 28px; }
  .rules i { display: block; width: 76px; height: 6px; }
</style></head>
<body>
  <div>
    <div class="rules">
...
const brandLoaded = await page.evaluate(() => document.fonts.check("600 68px 'EB Garamond'"))
