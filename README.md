...
| `epistemic-adequacy-under-pressure-probe` | evidence | design | Crosses the two effects the programme has established separately: that epistemic metadata reduces ungrounded answers, and that pressure increases them. It asks whether the protection survives the pressure. |
