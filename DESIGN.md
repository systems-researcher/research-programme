...
| 2026-08-20 | The dependency graph is positioned in Python and drawn as hand-written SVG | Auto-layout cannot be told what a picture means — it produced the Mermaid diagram this replaced. Longest-path layering guarantees every edge flows left to right, which is what makes the graph readable without a legend. |
